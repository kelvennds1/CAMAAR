...
Funcionalidade: Importação de dados do SIGAA (#113)
  ...
  Contexto:
    ...
    E estou na página de importação SIGAA
  ...
  Cenário: Importar novos dados do SIGAA com sucesso
    ...
    E eu confirmo a importação dos dados
    ...
    E devo ver a mensagem que contém "Importação concluída:"
  ...
  Cenário: Evitar duplicação de dados já existentes na base
    ...
    E devo ver a mensagem que contém "Importação concluída:"
    E devo ver a mensagem que contém "registros ignorados por já existirem"
  ...
  Cenário: Erro de validação quando o arquivo JSON está inválido
    ...
    Então devo ver a mensagem que contém "Arquivo JSON inválido"
